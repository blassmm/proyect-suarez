    ...
    <section className={styles.servicesSection}>
      ...
      <div className={styles.servicesContent}>
        <div className={styles.servicesHeader}>
          <p className={styles.yearsText}>Con más de 35 años en el mercado,</p>
          <h2 className={styles.leadershipText}>
            lideramos como taller modelo a nivel mundial.
          </h2>
          <p className={styles.teamText}>
            Tenemos el respaldo de un gran equipo de profesionales que trabaja
            día a día para lograr la perfección en cada proceso abordado.
          </p>
        </div>
